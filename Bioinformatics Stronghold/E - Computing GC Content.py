"""Given a set of DNA sequences in FASTA format, return the ID of the
string having the highest GC-content, followed by the GC-content of
that string:"""
...
def gc_content(fasta_dictionary: dict):
    """Given a dictionary of DNA sequences, returns another dictionary
    with the GC percentage of each sequence"""
...
"""Return the sequence with highest GC content:"""
